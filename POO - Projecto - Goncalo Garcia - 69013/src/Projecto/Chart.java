	...
	public void update(Observable arg0, Object arg1) {
		...
		for (String line : potencias.keySet()) {
			try {
				...
				// ).intValue();
				double lastY = series.getY(series.getItemCount() - 1).doubleValue();
				setPoint(line,Relogio.getInstanciaUnica().getTempoAtual() - 1,lastY);
			} catch (UnknownKeyException e) {
			}
			setPoint(line, Relogio.getInstanciaUnica().getTempoAtual(),potencias.get(line));
		}
